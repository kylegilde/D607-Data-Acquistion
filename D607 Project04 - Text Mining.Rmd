...
load_packages <- c("prettydoc", "SnowballC", "knitr", "rvest", "stringr", "tm", "RTextTools", "caret")
...
#randomly assign test and training groups
group_attr <- "group"
...
#let's look at the new metadata
meta(my_corpus[[1]])
```
