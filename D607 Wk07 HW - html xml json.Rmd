...
load_packages <- c("RCurl","prettydoc", "stringr", "dplyr", "knitr", "janitor", "XML")
...
#1. HTML Table 
##Load data, look at the HTML Table & its data frame
```{r load}
...
#2. XML Table 
##Load data, look at the XML & its data frame
```{r tidy_data}

url_XML <- getURLContent("https://raw.githubusercontent.com/kylegilde/D607-Data-Acquistion/master/data-sets/books/books.xml")

writeLines(str_sub(url_XML, 1, 501))
